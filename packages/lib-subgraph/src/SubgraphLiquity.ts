...
export class SubgraphLiquity implements ReadableLiquity, ObservableLiquity {
  ...
  getUSDHInStabilityPool() {
    return tokensInStabilityPool.get(this.client, undefined);
  }

  watchUSDHInStabilityPool(onUSDHInStabilityPoolChanged: (usdhInStabilityPool: Decimal) => void) {
    return tokensInStabilityPool.watch(this.client, onUSDHInStabilityPoolChanged, undefined);
  }
