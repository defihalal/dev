...
import usdhTokenAbi from "../abi/USDHToken.json";
...
import halalTokenAbi from "../abi/HALALToken.json";
import hintHelpersAbi from "../abi/HintHelpers.json";
import lockupContractFactoryAbi from "../abi/LockupContractFactory.json";
import halalStakingAbi from "../abi/HALALStaking.json";
...
export interface _LiquityContracts {
  ...
  halalToken: HALALToken;
  hintHelpers: HintHelpers;
  lockupContractFactory: LockupContractFactory;
  halalStaking: HALALStaking;
...
export interface _LiquityDeploymentJSON {
  ...
  readonly totalStabilityPoolHALALReward: string;
  readonly liquidityMiningHALALRewardRate: string;
