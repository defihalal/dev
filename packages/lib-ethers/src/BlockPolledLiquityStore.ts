...
export class BlockPolledLiquityStore extends LiquityStore<BlockPolledLiquityStoreExtraState> {
  ...
  private async _get(
    ...
    const {
      ...
      usdhInStabilityPool: this._readable.getUSDHInStabilityPool({ blockTag }),
      totalStakedHALAL: this._readable.getTotalStakedHALAL({ blockTag }),
      _riskiestTroveBeforeRedistribution: this._getRiskiestTroveBeforeRedistribution({ blockTag }),
      totalStakedUniTokens: this._readable.getTotalStakedUniTokens({ blockTag }),
      remainingStabilityPoolHALALReward: this._readable.getRemainingStabilityPoolHALALReward({
        blockTag
      }),
      ...
      ...(userAddress
        ? {
            ...
            usdhBalance: this._readable.getUSDHBalance(userAddress, { blockTag }),
            halalBalance: this._readable.getHALALBalance(userAddress, { blockTag }),
            ...
            liquidityMiningHALALReward: this._readable.getLiquidityMiningHALALReward(userAddress, {
              blockTag
            }),
    ...
    return [
      {
        ...
        remainingLiquidityMiningHALALReward: calculateRemainingHALAL(blockTimestamp)
      },
      {
        blockTag,
        blockTimestamp,
