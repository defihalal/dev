...
export class EthersLiquity implements ReadableEthersLiquity, TransactableLiquity {
  ...
  getRemainingStabilityPoolHALALReward(overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getRemainingStabilityPoolHALALReward(overrides);
  }
  ...
  getUSDHInStabilityPool(overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getUSDHInStabilityPool(overrides);
  }
  ...
  getUSDHBalance(address?: string, overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getUSDHBalance(address, overrides);
  }
  ...
  getHALALBalance(address?: string, overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getHALALBalance(address, overrides);
  }
  ...
  /** @internal */
  _getRemainingLiquidityMiningHALALRewardCalculator(
    overrides?: EthersCallOverrides
  ): Promise<(blockTimestamp: number) => Decimal> {
    return this._readable._getRemainingLiquidityMiningHALALRewardCalculator(overrides);
  }
  ...
  getRemainingLiquidityMiningHALALReward(overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getRemainingLiquidityMiningHALALReward(overrides);
  }
  ...
  getLiquidityMiningHALALReward(
    ...
    return this._readable.getLiquidityMiningHALALReward(address, overrides);
  }
  ...
  getHALALStake(address?: string, overrides?: EthersCallOverrides): Promise<HALALStake> {
    return this._readable.getHALALStake(address, overrides);
  }
  ...
  getTotalStakedHALAL(overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getTotalStakedHALAL(overrides);
  }
  ...
  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.borrowUSDH}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  borrowUSDH(
    ...
    return this.send.borrowUSDH(amount, maxBorrowingRate, overrides).then(waitForSuccess);
  }

  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.repayUSDH}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  repayUSDH(
    ...
    return this.send.repayUSDH(amount, overrides).then(waitForSuccess);
  }
  ...
  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.depositUSDHInStabilityPool}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  depositUSDHInStabilityPool(
    ...
    return this.send.depositUSDHInStabilityPool(amount, frontendTag, overrides).then(waitForSuccess);
  }

  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.withdrawUSDHFromStabilityPool}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  withdrawUSDHFromStabilityPool(
    ...
    return this.send.withdrawUSDHFromStabilityPool(amount, overrides).then(waitForSuccess);
  }
  ...
  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.sendUSDH}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  sendUSDH(
    ...
    return this.send.sendUSDH(toAddress, amount, overrides).then(waitForSuccess);
  }

  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.sendHALAL}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  sendHALAL(
    ...
    return this.send.sendHALAL(toAddress, amount, overrides).then(waitForSuccess);
  }

  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.redeemUSDH}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  redeemUSDH(
    ...
    return this.send.redeemUSDH(amount, maxRedemptionRate, overrides).then(waitForSuccess);
  }
  ...
  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.stakeHALAL}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  stakeHALAL(amount: Decimalish, overrides?: EthersTransactionOverrides): Promise<void> {
    return this.send.stakeHALAL(amount, overrides).then(waitForSuccess);
  }

  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.unstakeHALAL}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  unstakeHALAL(amount: Decimalish, overrides?: EthersTransactionOverrides): Promise<void> {
    return this.send.unstakeHALAL(amount, overrides).then(waitForSuccess);
  }
  ...
  /**
   * {@inheritDoc @liquity/lib-base#TransactableLiquity.withdrawHALALRewardFromLiquidityMining}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
   */
  withdrawHALALRewardFromLiquidityMining(overrides?: EthersTransactionOverrides): Promise<void> {
    return this.send.withdrawHALALRewardFromLiquidityMining(overrides).then(waitForSuccess);
  }
