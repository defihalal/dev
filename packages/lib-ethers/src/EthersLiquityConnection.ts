...
const connectionFrom = (
  ...
  {
    deploymentDate,
    totalStabilityPoolHALALReward,
    liquidityMiningHALALRewardRate,
    ...deployment
  }: _LiquityDeploymentJSON,
  ...
  return branded({
    ...
    totalStabilityPoolHALALReward: Decimal.from(totalStabilityPoolHALALReward),
    liquidityMiningHALALRewardRate: Decimal.from(liquidityMiningHALALRewardRate),
    ...deployment,
    ...optionalParams
  });
};
...
export interface EthersLiquityConnectionOptionalParams {
  /**
   * Address whose Trove, Stability Deposit, HALAL Stake and balances will be read by default.
   *
   * @remarks
  ...
  /**
   * Address that will receive HALAL rewards from newly created Stability Deposits by default.
   *
   * @remarks
   * For example
   * {@link EthersLiquity.depositUSDHInStabilityPool | depositUSDHInStabilityPool(amount, frontendTag?)}
