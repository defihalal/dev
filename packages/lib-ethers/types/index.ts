...
interface ActivePoolCalls {
  ...
  getUSDHDebt(_overrides?: CallOverrides): Promise<BigNumber>;
...
interface ActivePoolTransactions {
  decreaseUSDHDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseUSDHDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
...
export interface ActivePool
  ...
  readonly filters: {
    ...
    ActivePoolUSDHDebtUpdated(_USDHDebt?: null): EventFilter;
    ...
    USDHBalanceUpdated(_newBalance?: null): EventFilter;
  };
  ...
  extractEvents(logs: Log[], name: "ActivePoolUSDHDebtUpdated"): _TypedLogDescription<{ _USDHDebt: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "USDHBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
}
...
interface BorrowerOperationsCalls {
  ...
  USDH_GAS_COMPENSATION(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  halalStaking(_overrides?: CallOverrides): Promise<string>;
  halalStakingAddress(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  ...
  usdhToken(_overrides?: CallOverrides): Promise<string>;
}
...
interface BorrowerOperationsTransactions {
  ...
  adjustTrove(_maxFeePercentage: BigNumberish, _collWithdrawal: BigNumberish, _USDHChange: BigNumberish, _isDebtIncrease: boolean, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  ...
  openTrove(_maxFeePercentage: BigNumberish, _USDHAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  repayUSDH(_USDHAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_troveManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _sortedTrovesAddress: string, _usdhTokenAddress: string, _halalStakingAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawColl(_collWithdrawal: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  withdrawUSDH(_maxFeePercentage: BigNumberish, _USDHAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
}
...
export interface BorrowerOperations
  ...
  readonly filters: {
    ...
    HALALStakingAddressChanged(_halalStakingAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    ...
    USDHBorrowingFeePaid(_borrower?: string | null, _USDHFee?: null): EventFilter;
    USDHTokenAddressChanged(_usdhTokenAddress?: null): EventFilter;
  };
  ...
  extractEvents(logs: Log[], name: "HALALStakingAddressChanged"): _TypedLogDescription<{ _halalStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  ...
  extractEvents(logs: Log[], name: "USDHBorrowingFeePaid"): _TypedLogDescription<{ _borrower: string; _USDHFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "USDHTokenAddressChanged"): _TypedLogDescription<{ _usdhTokenAddress: string }>[];
}
...
interface CommunityIssuanceCalls {
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  HALALSupplyCap(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  halalToken(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  stabilityPoolAddress(_overrides?: CallOverrides): Promise<string>;
  totalHALALIssued(_overrides?: CallOverrides): Promise<BigNumber>;
}

interface CommunityIssuanceTransactions {
  issueHALAL(_overrides?: Overrides): Promise<BigNumber>;
  sendHALAL(_account: string, _HALALamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_halalTokenAddress: string, _stabilityPoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface CommunityIssuance
  extends _TypedLiquityContract<CommunityIssuanceCalls, CommunityIssuanceTransactions> {
  readonly filters: {
    HALALTokenAddressSet(_halalTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StabilityPoolAddressSet(_stabilityPoolAddress?: null): EventFilter;
    TotalHALALIssuedUpdated(_totalHALALIssued?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "HALALTokenAddressSet"): _TypedLogDescription<{ _halalTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressSet"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "TotalHALALIssuedUpdated"): _TypedLogDescription<{ _totalHALALIssued: BigNumber }>[];
}
...
export interface DefaultPool
  ...
  readonly filters: {
    ...
    DefaultPoolUSDHDebtUpdated(_USDHDebt?: null): EventFilter;
    ETHBalanceUpdated(_newBalance?: null): EventFilter;
    EtherSent(_to?: null, _amount?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "DefaultPoolUSDHDebtUpdated"): _TypedLogDescription<{ _USDHDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "ETHBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "EtherSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
...
interface HintHelpersCalls {
  ...
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionHints(_USDHamount: BigNumberish, _price: BigNumberish, _maxIterations: BigNumberish, _overrides?: CallOverrides): Promise<{ firstRedemptionHint: string; partialRedemptionHintNICR: BigNumber; truncatedUSDHamount: BigNumber }>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface LockupContractFactoryCalls {
  ...
  halalTokenAddress(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
...
interface LockupContractFactoryTransactions {
  ...
  setHALALTokenAddress(_halalTokenAddress: string, _overrides?: Overrides): Promise<void>;
}
...
interface USDHTokenTransactions {
  approve(spender: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
...
export interface USDHToken
  extends _TypedLiquityContract<USDHTokenCalls, USDHTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
    Transfer(from?: string | null, to?: string | null, value?: null): EventFilter;
    TroveManagerAddressChanged(_troveManagerAddress?: null): EventFilter;
    USDHTokenBalanceUpdated(_user?: null, _amount?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "Approval"): _TypedLogDescription<{ owner: string; spender: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{ _troveManagerAddress: string }>[];
  extractEvents(logs: Log[], name: "USDHTokenBalanceUpdated"): _TypedLogDescription<{ _user: string; _amount: BigNumber }>[];
}

interface HALALStakingCalls {
  DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
  F_ETH(_overrides?: CallOverrides): Promise<BigNumber>;
  F_USDH(_overrides?: CallOverrides): Promise<BigNumber>;
  NAME(_overrides?: CallOverrides): Promise<string>;
  activePoolAddress(_overrides?: CallOverrides): Promise<string>;
  borrowerOperationsAddress(_overrides?: CallOverrides): Promise<string>;
  getPendingETHGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getPendingUSDHGain(_user: string, _overrides?: CallOverrides): Promise<BigNumber>;
  halalToken(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  snapshots(arg0: string, _overrides?: CallOverrides): Promise<{ F_ETH_Snapshot: BigNumber; F_USDH_Snapshot: BigNumber }>;
  stakes(arg0: string, _overrides?: CallOverrides): Promise<BigNumber>;
  totalHALALStaked(_overrides?: CallOverrides): Promise<BigNumber>;
  troveManagerAddress(_overrides?: CallOverrides): Promise<string>;
  usdhToken(_overrides?: CallOverrides): Promise<string>;
}

interface HALALStakingTransactions {
  increaseF_ETH(_ETHFee: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseF_USDH(_USDHFee: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_halalTokenAddress: string, _usdhTokenAddress: string, _troveManagerAddress: string, _borrowerOperationsAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
  stake(_HALALamount: BigNumberish, _overrides?: Overrides): Promise<void>;
  unstake(_HALALamount: BigNumberish, _overrides?: Overrides): Promise<void>;
}

export interface HALALStaking
  extends _TypedLiquityContract<HALALStakingCalls, HALALStakingTransactions> {
  readonly filters: {
    ...
    F_USDHUpdated(_F_USDH?: null): EventFilter;
    HALALTokenAddressSet(_halalTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StakeChanged(staker?: string | null, newStake?: null): EventFilter;
    StakerSnapshotsUpdated(_staker?: null, _F_ETH?: null, _F_USDH?: null): EventFilter;
    StakingGainsWithdrawn(staker?: string | null, USDHGain?: null, ETHGain?: null): EventFilter;
    TotalHALALStakedUpdated(_totalHALALStaked?: null): EventFilter;
    TroveManagerAddressSet(_troveManager?: null): EventFilter;
    USDHTokenAddressSet(_usdhTokenAddress?: null): EventFilter;
  };
  ...
  extractEvents(logs: Log[], name: "F_USDHUpdated"): _TypedLogDescription<{ _F_USDH: BigNumber }>[];
  extractEvents(logs: Log[], name: "HALALTokenAddressSet"): _TypedLogDescription<{ _halalTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "StakeChanged"): _TypedLogDescription<{ staker: string; newStake: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakerSnapshotsUpdated"): _TypedLogDescription<{ _staker: string; _F_ETH: BigNumber; _F_USDH: BigNumber }>[];
  extractEvents(logs: Log[], name: "StakingGainsWithdrawn"): _TypedLogDescription<{ staker: string; USDHGain: BigNumber; ETHGain: BigNumber }>[];
  extractEvents(logs: Log[], name: "TotalHALALStakedUpdated"): _TypedLogDescription<{ _totalHALALStaked: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressSet"): _TypedLogDescription<{ _troveManager: string }>[];
  extractEvents(logs: Log[], name: "USDHTokenAddressSet"): _TypedLogDescription<{ _usdhTokenAddress: string }>[];
}

interface HALALTokenCalls {
...
interface HALALTokenTransactions {
  approve(spender: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  decreaseAllowance(spender: string, subtractedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  increaseAllowance(spender: string, addedValue: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  permit(owner: string, spender: string, amount: BigNumberish, deadline: BigNumberish, v: BigNumberish, r: BytesLike, s: BytesLike, _overrides?: Overrides): Promise<void>;
  sendToHALALStaking(_sender: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  transfer(recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
  transferFrom(sender: string, recipient: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
}

export interface HALALToken
  extends _TypedLiquityContract<HALALTokenCalls, HALALTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    CommunityIssuanceAddressSet(_communityIssuanceAddress?: null): EventFilter;
    HALALStakingAddressSet(_halalStakingAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "HALALStakingAddressSet"): _TypedLogDescription<{ _halalStakingAddress: string }>[];
...
interface MultiTroveGetterCalls {
  getMultipleSortedTroves(_startIdx: BigNumberish, _count: BigNumberish, _overrides?: CallOverrides): Promise<{ owner: string; debt: BigNumber; coll: BigNumber; stake: BigNumber; snapshotETH: BigNumber; snapshotUSDHDebt: BigNumber }[]>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
  troveManager(_overrides?: CallOverrides): Promise<string>;
}
...
interface StabilityPoolCalls {
  ...
  getCompoundedUSDHDeposit(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorETHGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorHALALGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getETH(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getFrontEndHALALGain(_frontEnd: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getTotalUSDHDeposits(_overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  lastETHError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  lastHALALError(_overrides?: CallOverrides): Promise<BigNumber>;
  lastUSDHLossError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
  troveManager(_overrides?: CallOverrides): Promise<string>;
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _troveManagerAddress: string, _activePoolAddress: string, _usdhTokenAddress: string, _sortedTrovesAddress: string, _priceFeedAddress: string, _communityIssuanceAddress: string, _overrides?: Overrides): Promise<void>;
...
export interface StabilityPool
  ...
  readonly filters: {
    ...
    ETHGainWithdrawn(_depositor?: string | null, _ETH?: null, _USDHLoss?: null): EventFilter;
    ...
    HALALPaidToDepositor(_depositor?: string | null, _HALAL?: null): EventFilter;
    HALALPaidToFrontEnd(_frontEnd?: string | null, _HALAL?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    ...
    StabilityPoolUSDHBalanceUpdated(_newBalance?: null): EventFilter;
    TroveManagerAddressChanged(_newTroveManagerAddress?: null): EventFilter;
    USDHTokenAddressChanged(_newUSDHTokenAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "ETHGainWithdrawn"): _TypedLogDescription<{ _depositor: string; _ETH: BigNumber; _USDHLoss: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "HALALPaidToDepositor"): _TypedLogDescription<{ _depositor: string; _HALAL: BigNumber }>[];
  extractEvents(logs: Log[], name: "HALALPaidToFrontEnd"): _TypedLogDescription<{ _frontEnd: string; _HALAL: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  ...
  extractEvents(logs: Log[], name: "StabilityPoolUSDHBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{ _newTroveManagerAddress: string }>[];
  extractEvents(logs: Log[], name: "USDHTokenAddressChanged"): _TypedLogDescription<{ _newUSDHTokenAddress: string }>[];
...
interface TroveManagerCalls {
  ...
  L_USDHDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  defaultPool(_overrides?: CallOverrides): Promise<string>;
  getBorrowingFee(_USDHDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  getBorrowingFeeWithDecay(_USDHDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getEntireDebtAndColl(_borrower: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; pendingUSDHDebtReward: BigNumber; pendingETHReward: BigNumber }>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getPendingUSDHDebtReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  lastUSDHDebtError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  rewardSnapshots(arg0: string, _overrides?: CallOverrides): Promise<{ ETH: BigNumber; USDHDebt: BigNumber }>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
interface TroveManagerTransactions {
  ...
  redeemCollateral(_USDHamount: BigNumberish, _firstRedemptionHint: string, _upperPartialRedemptionHint: string, _lowerPartialRedemptionHint: string, _partialRedemptionHintNICR: BigNumberish, _maxIterations: BigNumberish, _maxFeePercentage: BigNumberish, _overrides?: Overrides): Promise<void>;
  removeStake(_borrower: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _usdhTokenAddress: string, _sortedTrovesAddress: string, _halalTokenAddress: string, _halalStakingAddress: string, _overrides?: Overrides): Promise<void>;
...
export interface TroveManager
  ...
  readonly filters: {
    ...
    GasPoolAddressChanged(_gasPoolAddress?: null): EventFilter;
    HALALStakingAddressChanged(_halalStakingAddress?: null): EventFilter;
    HALALTokenAddressChanged(_halalTokenAddress?: null): EventFilter;
    LTermsUpdated(_L_ETH?: null, _L_USDHDebt?: null): EventFilter;
    LastFeeOpTimeUpdated(_lastFeeOpTime?: null): EventFilter;
    Liquidation(_liquidatedDebt?: null, _liquidatedColl?: null, _collGasCompensation?: null, _USDHGasCompensation?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    Redemption(_attemptedUSDHAmount?: null, _actualUSDHAmount?: null, _ETHSent?: null, _ETHFee?: null): EventFilter;
    SortedTrovesAddressChanged(_sortedTrovesAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_stabilityPoolAddress?: null): EventFilter;
    ...
    TroveSnapshotsUpdated(_L_ETH?: null, _L_USDHDebt?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "GasPoolAddressChanged"): _TypedLogDescription<{ _gasPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "HALALStakingAddressChanged"): _TypedLogDescription<{ _halalStakingAddress: string }>[];
  extractEvents(logs: Log[], name: "HALALTokenAddressChanged"): _TypedLogDescription<{ _halalTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "LTermsUpdated"): _TypedLogDescription<{ _L_ETH: BigNumber; _L_USDHDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "LastFeeOpTimeUpdated"): _TypedLogDescription<{ _lastFeeOpTime: BigNumber }>[];
  extractEvents(logs: Log[], name: "Liquidation"): _TypedLogDescription<{ _liquidatedDebt: BigNumber; _liquidatedColl: BigNumber; _collGasCompensation: BigNumber; _USDHGasCompensation: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "Redemption"): _TypedLogDescription<{ _attemptedUSDHAmount: BigNumber; _actualUSDHAmount: BigNumber; _ETHSent: BigNumber; _ETHFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "SortedTrovesAddressChanged"): _TypedLogDescription<{ _sortedTrovesAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "TroveSnapshotsUpdated"): _TypedLogDescription<{ _L_ETH: BigNumber; _L_USDHDebt: BigNumber }>[];
...
interface UnipoolTransactions {
  ...
  setParams(_halalTokenAddress: string, _uniTokenAddress: string, _duration: BigNumberish, _overrides?: Overrides): Promise<void>;
