 ...
 * {@link @liquity/lib-base#USDH_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some USDH amounts are not possible to redeem exactly.
 *
 * When {@link @liquity/lib-base#PopulatableLiquity.redeemUSDH | redeemUSDH()} is called with an
 * amount that can't be fully redeemed, the amount will be truncated (see the `redeemableUSDHAmount`
 ...
 * {@link @liquity/lib-base#USDH_MINIMUM_NET_DEBT}.
 *
 * @public
 */
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
  ...
  /** Whether `redeemableUSDHAmount` is less than `attemptedUSDHAmount`. */
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown>
  ...
  /** {@inheritDoc TransactableLiquity.borrowUSDH} */
  borrowUSDH(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish
  ): Promise<
  ...
  /** {@inheritDoc TransactableLiquity.repayUSDH} */
  repayUSDH(
    amount: Decimalish
  ): Promise<
    PopulatedLiquityTransaction<
  ...
  /** {@inheritDoc TransactableLiquity.depositUSDHInStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.withdrawUSDHFromStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.sendUSDH} */
  sendUSDH(
    toAddress: string,
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;

  /** {@inheritDoc TransactableLiquity.sendHALAL} */
  sendHALAL(
    toAddress: string,
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;

  /** {@inheritDoc TransactableLiquity.redeemUSDH} */
  redeemUSDH(
    amount: Decimalish,
    maxRedemptionRate?: Decimalish
  ): Promise<PopulatedRedemption<P, S, R>>;
  ...
  /** {@inheritDoc TransactableLiquity.stakeHALAL} */
  stakeHALAL(
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;

  /** {@inheritDoc TransactableLiquity.unstakeHALAL} */
  unstakeHALAL(
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
  ...
  /** {@inheritDoc TransactableLiquity.withdrawHALALRewardFromLiquidityMining} */
  withdrawHALALRewardFromLiquidityMining(): Promise<
    PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>
  >;
