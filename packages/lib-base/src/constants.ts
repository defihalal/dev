 ...
 * @public
 */
// export const USDH_LIQUIDATION_RESERVE = Decimal.from(200);
export const USDH_LIQUIDATION_RESERVE = Decimal.from(1);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link USDH_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
// export const USDH_MINIMUM_NET_DEBT = Decimal.from(1800);
export const USDH_MINIMUM_NET_DEBT = Decimal.from(9);
 ...
 * @public
 */
export const USDH_MINIMUM_DEBT = USDH_LIQUIDATION_RESERVE.add(USDH_MINIMUM_NET_DEBT);
