...
export interface ReadableLiquity {
  ...
  /**
   * Get the amount of HALAL held by an address.
   *
   * @param address - Address whose balance should be retrieved.
   */
  getHALALBalance(address?: string): Promise<Decimal>;

  /**
   * Get the amount of Uniswap ETH/USDH LP tokens held by an address.
   *
   * @param address - Address whose balance should be retrieved.
   */
  ...
  /**
   * Get the liquidity mining contract's allowance of a holder's Uniswap ETH/USDH LP tokens.
   *
   * @param address - Address holding the Uniswap ETH/USDH LP tokens.
   */
  ...
  /**
   * Get the amount of Uniswap ETH/USDH LP tokens currently staked by an address in liquidity mining.
   *
  ...
  /**
   * Get the total amount of Uniswap ETH/USDH LP tokens currently staked in liquidity mining.
   */
   ...
   *
   * @param address - Address whose HALAL reward should be retrieved.
   */
   ...
   *
   * @param address - Address that owns the HALAL Stake.
   */
