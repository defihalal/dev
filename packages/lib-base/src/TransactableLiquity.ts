...
export interface TroveCreationDetails {
  ...
  /** Amount of USDH added to the Trove's debt as borrowing fee. */
  fee: Decimal;
}
...
/**
 * Details of a {@link TransactableLiquity.redeemUSDH | redeemUSDH()} transaction.
 *
 * @public
 */
export interface RedemptionDetails {
   ...
   *
   * @remarks
   * This can end up being lower than `attemptedUSDHAmount` due to interference from another
...
/**
 * Details of a
 * {@link TransactableLiquity.depositUSDHInStabilityPool | depositUSDHInStabilityPool()} or
 * {@link TransactableLiquity.withdrawUSDHFromStabilityPool | withdrawUSDHFromStabilityPool()}
 * transaction.
 *
 * @public
 */
...
export interface TransactableLiquity {
  /**
   * Open a new Trove by depositing collateral and borrowing USDH.
   *
   ...
   * {@link @liquity/lib-base#USDH_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   *
   * @param amount - The amount of USDH to borrow.
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @liquity/lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   *
   * @param amount - The amount of USDH to repay.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @param amount - Amount of USDH to add to new or existing deposit.
   * @param frontendTag - Address that should receive a share of this deposit's HALAL rewards.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   * {@link @liquity/lib-base#StabilityDeposit.halalReward | HALAL reward}.
   */
   ...
   *
   * @param amount - Amount of USDH to withdraw.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   * {@link @liquity/lib-base#StabilityDeposit.halalReward | HALAL reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   * @param amount - Amount of USDH to send.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   *
   * @param toAddress - Address of receipient.
   * @param amount - Amount of HALAL to send.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  sendHALAL(toAddress: string, amount: Decimalish): Promise<void>;

  /**
   * Redeem USDH to native currency (e.g. Ether) at face value.
   *
   * @param amount - Amount of USDH to be redeemed.
   ...
   */
  redeemUSDH(amount: Decimalish, maxRedemptionRate?: Decimalish): Promise<RedemptionDetails>;
   ...
   *
   * @param amount - Amount of HALAL to add to new or existing stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   * @remarks
   * As a side-effect, the transaction will also pay out an existing HALAL stake's
   * {@link @liquity/lib-base#HALALStake.collateralGain | collateral gain} and
   * {@link @liquity/lib-base#HALALStake.usdhGain | USDH gain}.
   */
   ...
   *
   * @param amount - Amount of HALAL to withdraw.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   * @remarks
   * As a side-effect, the transaction will also pay out the HALAL stake's
   * {@link @liquity/lib-base#HALALStake.collateralGain | collateral gain} and
   * {@link @liquity/lib-base#HALALStake.usdhGain | USDH gain}.
   */
  ...
  /**
   * Withdraw {@link @liquity/lib-base#HALALStake.collateralGain | collateral gain} and
   * {@link @liquity/lib-base#HALALStake.usdhGain | USDH gain} from HALAL stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Allow the liquidity mining contract to use Uniswap ETH/USDH LP tokens for
  ...
  /**
   * Stake Uniswap ETH/USDH LP tokens to participate in liquidity mining and earn HALAL.
   *
  ...
  /**
   * Withdraw Uniswap ETH/USDH LP tokens from liquidity mining.
   *
   ...
   *
   * @param kickbackRate - The portion of HALAL rewards to pass onto users of the frontend
   *                       (between 0 and 1).
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
