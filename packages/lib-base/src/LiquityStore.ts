...
export interface LiquityStoreBaseState {
  ...
  /** User's Uniswap ETH/USDH LP token balance. */
  uniTokenBalance: Decimal;

  /** The liquidity mining contract's allowance of user's Uniswap ETH/USDH LP tokens. */
  ...
  /** Amount of Uniswap ETH/USDH LP tokens the user has staked in liquidity mining. */
  liquidityMiningStake: Decimal;

  /** Total amount of Uniswap ETH/USDH LP tokens currently staked in liquidity mining. */
...
export interface LiquityStoreDerivedState {
   ...
   *
   * @remarks
   * Note that the actual rate paid by a redemption transaction will depend on the amount of USDH
   * being redeemed.
   *
...
export abstract class LiquityStore<T = unknown> {
  ...
  private _reduce(
    ...
    return {
      ...
      usdhBalance: this._updateIfChanged(
        eq,
        "usdhBalance",
        baseState.usdhBalance,
        baseStateUpdate.usdhBalance
      ),

      halalBalance: this._updateIfChanged(
        eq,
        "halalBalance",
        baseState.halalBalance,
        baseStateUpdate.halalBalance
      ),
      ...
      remainingLiquidityMiningHALALReward: this._silentlyUpdateIfChanged(
        eq,
        baseState.remainingLiquidityMiningHALALReward,
        baseStateUpdate.remainingLiquidityMiningHALALReward
      ),
      ...
      liquidityMiningHALALReward: this._silentlyUpdateIfChanged(
        eq,
        baseState.liquidityMiningHALALReward,
        baseStateUpdate.liquidityMiningHALALReward
      ),
      ...
      usdhInStabilityPool: this._updateIfChanged(
        eq,
        "usdhInStabilityPool",
        baseState.usdhInStabilityPool,
        baseStateUpdate.usdhInStabilityPool
      ),
      ...
      remainingStabilityPoolHALALReward: this._silentlyUpdateIfChanged(
        eq,
        baseState.remainingStabilityPoolHALALReward,
        baseStateUpdate.remainingStabilityPoolHALALReward
      ),
      ...
      halalStake: this._updateIfChanged(
        equals,
        "halalStake",
        baseState.halalStake,
        baseStateUpdate.halalStake
      ),

      totalStakedHALAL: this._updateIfChanged(
        eq,
        "totalStakedHALAL",
        baseState.totalStakedHALAL,
        baseStateUpdate.totalStakedHALAL
      ),
