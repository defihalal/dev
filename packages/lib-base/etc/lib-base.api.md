...
export class _CachedReadableLiquity<T extends unknown[]> implements _ReadableLiquityWithExtraParams<T> {
    ...
    // (undocumented)
    getHALALBalance(address?: string, ...extraParams: T): Promise<Decimal>;
    // (undocumented)
    getHALALStake(address?: string, ...extraParams: T): Promise<HALALStake>;
    // (undocumented)
    getLiquidityMiningHALALReward(address?: string, ...extraParams: T): Promise<Decimal>;
    // (undocumented)
    ...
    // (undocumented)
    getRemainingLiquidityMiningHALALReward(...extraParams: T): Promise<Decimal>;
    // (undocumented)
    getRemainingStabilityPoolHALALReward(...extraParams: T): Promise<Decimal>;
    // (undocumented)
    ...
    // (undocumented)
    getTotalStakedHALAL(...extraParams: T): Promise<Decimal>;
    // (undocumented)
    ...
    // (undocumented)
    getUSDHBalance(address?: string, ...extraParams: T): Promise<Decimal>;
    // (undocumented)
    getUSDHInStabilityPool(...extraParams: T): Promise<Decimal>;
    }
...
// @internal (undocumented)
export type _DebtChange<T> = (_USDHBorrowing<T> & _NoUSDHRepayment) | (_USDHRepayment<T> & _NoUSDHBorrowing);
...
export class HALALStake {
    // @internal
    constructor(stakedHALAL?: Decimal, collateralGain?: Decimal, usdhGain?: Decimal);
...
// @internal (undocumented)
export type _NoUSDHBorrowing = Partial<_USDHBorrowing<undefined>>;

// @internal (undocumented)
export type _NoUSDHRepayment = Partial<_USDHRepayment<undefined>>;
...
export interface ObservableLiquity {
    ...
    // (undocumented)
    watchUSDHInStabilityPool(onUSDHInStabilityPoolChanged: (usdhInStabilityPool: Decimal) => void): () => void;
}
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown> extends _PopulatableFrom<SendableLiquity<R, S>, P> {
    ...
    borrowUSDH(amount: Decimalish, maxBorrowingRate?: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>>;
    ...
    depositUSDHInStabilityPool(amount: Decimalish, frontendTag?: string): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, StabilityDepositChangeDetails>>>>;
    ...
    redeemUSDH(amount: Decimalish, maxRedemptionRate?: Decimalish): Promise<PopulatedRedemption<P, S, R>>;
    ...
    repayUSDH(amount: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>>;
    sendHALAL(toAddress: string, amount: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
    sendUSDH(toAddress: string, amount: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
    // @internal (undocumented)
    ...
    withdrawHALALRewardFromLiquidityMining(): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
...
export interface SendableLiquity<R = unknown, S = unknown> extends _SendableFrom<TransactableLiquity, R, S> {
    ...
    borrowUSDH(amount: Decimalish, maxBorrowingRate?: Decimalish): Promise<SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>;
    ...
    depositUSDHInStabilityPool(amount: Decimalish, frontendTag?: string): Promise<SentLiquityTransaction<S, LiquityReceipt<R, StabilityDepositChangeDetails>>>;
    ...
    redeemUSDH(amount: Decimalish, maxRedemptionRate?: Decimalish): Promise<SentLiquityTransaction<S, LiquityReceipt<R, RedemptionDetails>>>;
    ...
    sendHALAL(toAddress: string, amount: Decimalish): Promise<SentLiquityTransaction<S, LiquityReceipt<R, void>>>;
    ...
    withdrawHALALRewardFromLiquidityMining(): Promise<SentLiquityTransaction<S, LiquityReceipt<R, void>>>;
...
export class StabilityDeposit {
    // @internal
    constructor(initialUSDH: Decimal, currentUSDH: Decimal, collateralGain: Decimal, halalReward: Decimal, frontendTag: string);
...
export type StabilityDepositChange<T> = {
    depositUSDH: T;
    withdrawUSDH?: undefined;
} | {
    depositUSDH?: undefined;
    withdrawUSDH: T;
    withdrawAllUSDH: boolean;
};
...
export interface TransactableLiquity {
    ...
    depositUSDHInStabilityPool(amount: Decimalish, frontendTag?: string): Promise<StabilityDepositChangeDetails>;
...
// Warning: (ae-incompatible-release-tags) The symbol "TroveClosureParams" is marked as @public, but its signature references "_USDHRepayment" which is marked as @internal
// Warning: (ae-incompatible-release-tags) The symbol "TroveClosureParams" is marked as @public, but its signature references "_NoUSDHBorrowing" which is marked as @internal
//
// @public
export type TroveClosureParams<T> = _CollateralWithdrawal<T> & _NoCollateralDeposit & Partial<_USDHRepayment<T>> & _NoUSDHBorrowing;
...
// Warning: (ae-incompatible-release-tags) The symbol "TroveCreationParams" is marked as @public, but its signature references "_USDHBorrowing" which is marked as @internal
// Warning: (ae-incompatible-release-tags) The symbol "TroveCreationParams" is marked as @public, but its signature references "_NoUSDHRepayment" which is marked as @internal
//
// @public
export type TroveCreationParams<T = unknown> = _CollateralDeposit<T> & _NoCollateralWithdrawal & _USDHBorrowing<T> & _NoUSDHRepayment;
...
// @public
export const USDH_LIQUIDATION_RESERVE: Decimal;

// @public
export const USDH_MINIMUM_DEBT: Decimal;

// @public
export const USDH_MINIMUM_NET_DEBT: Decimal;

// @internal (undocumented)
export type _USDHBorrowing<T> = {
    borrowUSDH: T;
};

// @internal (undocumented)
export type _USDHRepayment<T> = {
    repayUSDH: T;
};
