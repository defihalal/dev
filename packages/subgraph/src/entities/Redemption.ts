...
export function finishCurrentRedemption(
  ...
  _attemptedUSDHAmount: BigInt,
  _actualUSDHAmount: BigInt,
  _ETHSent: BigInt,
  _ETHFee: BigInt
): void {
  ...
  currentRedemption.tokensAttemptedToRedeem = decimalize(_attemptedUSDHAmount);
  currentRedemption.tokensActuallyRedeemed = decimalize(_actualUSDHAmount);
  currentRedemption.collateralRedeemed = decimalize(_ETHSent);
  currentRedemption.partial = _actualUSDHAmount < _attemptedUSDHAmount;
