...
contract("Gas cost tests", async accounts => {
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 0 existing Troves in system. Adds 10 ether and issues 100 USDH'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 1 existing Trove in system. Adds 10 ether and issues 100 USDH'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, Inserts between 2 existing CDs in system. Adds 10 ether and issues 80 USDH. '
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues 100 USDH'

  //   const amountETH = dec(10, 'ether')
  //   const amountUSDH = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountUSDH)
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues less USDH than the previous one'
  //   const amountETH = dec(10, 'ether')
  //   const amountUSDH = 200
  //   const gasResults = await th.openTrove_allAccounts_decreasingUSDHAmounts(_10_Accounts, contracts, amountETH, amountUSDH)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = "openTrove(), 50 accounts, each account adds random ether and random USDH";
    const amountETH = dec(10, "ether");
    const amountUSDH = 0;
    const gasResults = await th.openTrove_allAccounts_randomETH_randomUSDH(
      1,
      9,
      _50_Accounts,
      contracts,
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/USDH Increase/Increase. 10 accounts, each account adjusts up -  1 ether and 100 USDH'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })

  //   const amountETH = dec(10, 'ether')
  //   const amountUSDH = dec(100, 18)
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountUSDH)

  //   const amountETH_2 = dec(1, 'ether')
  //   const amountUSDH_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountUSDH_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/USDH Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 ether and 10 USDH'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountUSDH_2 = "-10000000000000000000" // debt decrease of 10 USDH
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountUSDH_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/USDH Increase/Decrease. 10 accounts, each account adjusts up by 0.1 ether and down by 10 USDH'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountETH = dec(10, 'ether')
  //   const amountUSDH = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountETH, amountUSDH)

  //   // Randomly add between 1-9 ETH, and withdraw 1-100 USDH
  ...
  it("", async () => {
    ...
    const amountUSDH = dec(100, 18);
    await th.openTrove_allAccounts(_40_Accounts, contracts, amountETH, amountUSDH);
    // Randomly add between 1-9 ETH, and withdraw 1-100 USDH
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingUSDHAmounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
      200
    ...
    for (account of _10_Accounts) {
      await usdhToken.unprotectedMint(account, dec(1000, 18));
    }
  ...
  it("", async () => {
    const message =
      "closeTrove(), 20 accounts, each account adds 10 ether and issues less USDH than the previous one. First 10 accounts close their trove. ";
  ...
  // it("", async () => {
  //   const message = 'withdrawUSDH(), first withdrawal, 10 accounts, each account withdraws 100 USDH'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)

  //   const gasResults = await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'withdrawUSDH(), second withdrawal, 10 accounts, each account withdraws 100 USDH'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message =
      "withdrawUSDH(), first withdrawal, 30 accounts, each account withdraws a random USDH amount";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);

    const gasResults = await th.withdrawUSDH_allAccounts_randomAmount(
      1,
      180,
      _30_Accounts,
      contracts
  ...
  it("", async () => {
    const message =
      "withdrawUSDH(), second withdrawal, 30 accounts, each account withdraws a random USDH amount";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_30_Accounts, contracts, dec(100, 18));
  ...
  // it("", async () => {
  //   const message = 'repayUSDH(), partial repayment, 10 accounts, repay 30 USDH (of 100 USDH)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repayUSDH_allAccounts(_10_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repayUSDH(), second partial repayment, 10 accounts, repay 30 USDH (of 70 USDH)'
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_30_Accounts, contracts, dec(100, 18))
  //   await th.repayUSDH_allAccounts(_30_Accounts, contracts, dec(30, 18))

  //   const gasResults = await th.repayUSDH_allAccounts(_30_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message =
      "repayUSDH(), partial repayment, 30 accounts, repay random amount of USDH (of 100 USDH)";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_30_Accounts, contracts, dec(100, 18));

    const gasResults = await th.repayUSDH_allAccounts_randomAmount(1, 99, _30_Accounts, contracts);
    th.logGasMetrics(gasResults, message);
    th.logAllGasCosts(gasResults);
  ...
  // it("", async () => {
  //   const message = 'repayUSDH(), first repayment, 10 accounts, repay in full (100 of 100 USDH)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repayUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = "repayUSDH(), first repayment, 30 accounts, repay in full (50 of 50 USDH)";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_30_Accounts, contracts, dec(100, 18));
    await th.repayUSDH_allAccounts(_30_Accounts, contracts, dec(50, 18));

    const gasResults = await th.repayUSDH_allAccounts(_30_Accounts, contracts, dec(50, 18));
    th.logGasMetrics(gasResults, message);
    th.logAllGasCosts(gasResults);
  ...
  it("", async () => {
    ...
    const randUSDHAmount = th.randAmountInWei(1, 180);
    await borrowerOperations.withdrawUSDH(_100pct, randUSDHAmount, accounts[1], ZERO_ADDRESS, {
      from: accounts[1]
    });
  ...
  it("", async () => {
    const message = "getCurrentICR(), Troves with 10 ether and 100 USDH withdrawn";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message = "getCurrentICR(), Troves with 10 ether and random USDH amount withdrawn";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts_randomAmount(1, 1300, _10_Accounts, contracts);
  ...
  it("", async () => {
    ...
    const randUSDHAmount = th.randAmountInWei(1, 180);
    await borrowerOperations.openTrove(_100pct, randUSDHAmount, accounts[1], ZERO_ADDRESS, {
      from: accounts[1],
      value: dec(10, "ether")
    });

    // acct 999 adds coll, withdraws USDH, sits at 111% ICR
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 ether and 100 USDH withdrawn, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), dec(100, 18));
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 ether and random USDH amount withdrawn, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 USDH, redemption hits 1 Trove. One account in system, partial redemption";
    await th.openTrove_allAccounts([accounts[0]], contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts([accounts[0]], contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 USDH, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption";
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, "ether"), 0);
    // 3 accounts withdraw successively less USDH
    await borrowerOperations.withdrawUSDH(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, {
      from: accounts[0]
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(90, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1]
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(80, 18), accounts[2], ZERO_ADDRESS, {
      from: accounts[2]
    });

    /* Account 2 redeems 50 USDH. It is redeemed from account 0's Trove, 
    leaving the Trove active with 30 USDH and ((200 *10 - 50 ) / 200 ) = 9.75 ETH. 
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 101 USDH, redemption hits 2 Troves, last redemption is partial";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 500 USDH, redeems 101 USDH
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether")
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(500, 18), whale, ZERO_ADDRESS, {
      from: whale
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 500 USDH, redemption hits 5 Troves, all full redemptions";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 500 USDH, redeems 500 USDH
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether")
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 450 USDH, redemption hits 5 Troves,  last redemption is partial (50 of 100 USDH)";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 450 USDH, redeems 500 USDH
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether")
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(450, 18), whale, ZERO_ADDRESS, {
      from: whale
    });
  ...
  it("", async () => {
    const message = "redeemCollateral(), redeemed 1000 USDH, redemption hits 10 Troves";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 1000 USDH, redeems 500 USDH
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether")
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(1000, 18), whale, ZERO_ADDRESS, {
      from: whale
    });
  ...
  it("", async () => {
    const message = "redeemCollateral(), redeemed 1500 USDH, redemption hits 15 Troves";
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_20_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 1500 USDH, redeems 1500 USDH
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether")
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(1500, 18), whale, ZERO_ADDRESS, {
      from: whale
    });
  ...
  it("", async () => {
    const message = "redeemCollateral(), redeemed 2000 USDH, redemption hits 20 Troves";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_30_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 2000 USDH, redeems 2000 USDH
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether")
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(2000, 18), whale, ZERO_ADDRESS, {
      from: whale
    });
  ...
  // it("", async () => {
  //   const message = 'redeemCollateral(),  USDH, each redemption only hits the first Trove, never closes it'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawUSDH_allAccounts(_20_Accounts, troveManager, dec(100, 18))
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 USDH, redemption hits 1 Trove, WITH pending rewards. One account in system";
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(100, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1]
    });

    // acct 998 adds coll, withdraws USDH, sits at 111% ICR
    await th.openTrove_allAccounts([accounts[998]], contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[998], ZERO_ADDRESS, {
      from: accounts[998]
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 USDH, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.";
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, "ether"), 0);
    // 3 accounts withdraw successively less USDH
    await borrowerOperations.withdrawUSDH(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, {
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 500 USDH, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1000 USDH, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1500 USDH, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_20_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 2000 USDH, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_30_Accounts, contracts, dec(100, 18));
  ...
  // it("", async () => {
  //   const message = 'redeemCollateral(),  USDH, each redemption only hits the first Trove, never closes it, WITH pending rewards'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawUSDH_allAccounts(_20_Accounts, troveManager, dec(100, 18))

  //    // acct 999 adds coll, withdraws USDH, sits at 111% ICR
  //    await borrowerOperations.addColl(accounts[999], {from: accounts[999], value:dec(1, 'ether')})
  //    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[999], ZERO_ADDRESS, { from: accounts[999]})
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0 )
  //   await th.withdrawUSDH_allAccounts_randomAmount(1, 180, _10_Accounts, borrowerOperations)
  ...
  //   await th.withdrawUSDH_allAccounts_randomAmount(1, 180, _10_Accounts, troveManager)
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, part of issued USDH: all accounts withdraw 180 USDH, all make first deposit, provide 100 USDH'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, all issued USDH: all accounts withdraw 180 USDH, all make first deposit, 180 USDH'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, all accounts withdraw 180 USDH, all make first deposit, random USDH amount";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(130, 18));
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, deposit part of issued USDH: all accounts withdraw 180 USDH, all make second deposit, provide 50 USDH";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(130, 18));
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18));

    // >>FF time and one account tops up, triggers HALAL gains for all
    await th.fastForwardTime(timeValues.SECONDS_IN_ONE_HOUR, web3.currentProvider);
    await stabilityPool.provideToSP(dec(1, 18), ZERO_ADDRESS, { from: _10_Accounts[0] });

    // Check the other accounts have HALAL gain
    for (account of _10_Accounts.slice(1)) {
      const HALALGain = await stabilityPool.getDepositorHALALGain(account);
      assert.isTrue(HALALGain.gt(toBN("0")));
    }
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, deposit all issued USDH: all accounts withdraw 180 USDH, make second deposit, provide 90 USDH'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, all accounts withdraw 180 USDH, make second deposit, random USDH amount";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(_10_Accounts, contracts, dec(130, 18));
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18));
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit part of issued USDH: all accounts make second deposit, provide 50 USDH'
  //   // 9 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 50 USDH to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 170 USDH
  ...
  //   // Check accounts have HALAL gains from liquidations
  ...
  //   // 9 active Troves top up their Stability Pool deposits with 50 USDH
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit all issued USDH: all accounts make second deposit, provide 90 USDH'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 90 USDH to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawUSDH_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 180 USDH
  //   await borrowerOperations.openTrove(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(1, 'ether') })
  ...
  //   // 5 active Troves top up their Stability Pool deposits with 90 USDH, using up all their issued USDH
  ...
  it("", async () => {
    const message =
      "provideToSP(), with pending rewards in system. deposit part of issued USDH: all make second deposit, provide random USDH amount";
    // 10 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 90 USDH to Stability Pool
    ...
    // 5 active Troves top up their Stability Pool deposits with a random USDH amount
    const gasResults = await th.provideToSP_allAccounts_randomAmount(
      1,
      49,
      accounts.slice(7, 12),
  ...
  // partial
  // it("", async () => {
  //   const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - 90 USDH of 180 USDH deposit'
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), no pending rewards. Stability Pool depositors make full withdrawal - 130 USDH of 130 USDH deposit";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), dec(190, 18));
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(130, 18));
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - random USDH amount, less than 180 USDH deposit";
  ...
  // it("", async () => {
  //   const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - 90 USDH of 130 USDH deposit'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 180 USDH to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  ...
  //   await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  //   // 5 active Troves reduce their Stability Pool deposit by 90 USDH
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), pending rewards in system. Stability Pool depositors make full withdrawal - 130 USDH of 130 USDH deposit";
    // 10 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 180 USDH to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, "ether"), dec(130, 18));
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18));
    ...
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1]
    });
    ...
    // 5 active Troves reduce their Stability Pool deposit by 130 USDH
    const gasResults = await th.withdrawFromSP_allAccounts(
      accounts.slice(7, 12),
      stabilityPool,
      dec(130, 18)
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - random amount of USDH";
    // 10 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 130 USDH to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, "ether"), dec(130, 18));
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18));
  ...
  // it("", async () => {
  //   const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 USDH, provide 180 USDH, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 130 USDH to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  it("", async () => {
    const message =
      "withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 USDH, provide a random amount, then withdraw all to SP after a liquidation";
    // 20 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 180 USDH to Stability Pool
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 180 USDH
    await th.openTrove_allAccounts(accounts.slice(100, 110), contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(accounts.slice(100, 110), contracts, dec(130, 18));

    //6s acct open Trove with 1 ether and withdraw 180 USDH (inc gas comp)
  ...
  it("", async () => {
    ...
    // 100 accts each open Trove with 10 ether, withdraw 180 USDH
    await th.openTrove_allAccounts(accounts.slice(100, 200), contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(accounts.slice(100, 200), contracts, dec(130, 18));

    const liquidationAcctRange = accounts.slice(1, 10);

    // Accts open Trove with 1 ether and withdraws 180 USDH (inc gas comp)
    await th.openTrove_allAccounts(liquidationAcctRange, contracts, dec(1, "ether"), 0);
    await th.withdrawUSDH_allAccounts(liquidationAcctRange, contracts, dec(130, 18));
  ...
  it("", async () => {
    ...
    //2 acct open Trove with 1 ether and withdraws 180 USDH (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(2, 4), contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, {
      from: accounts[2]
    });
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, {
      from: accounts[3]
    });
  ...
  it("", async () => {
    ...
    //3 acct open Trove with 1 ether and withdraws 180 USDH (inc gas comp)
    ...
    // Account 100 provides 600 USDH to pool
    await borrowerOperations.withdrawUSDH(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, {
      from: accounts[100]
    });
  ...
  it("", async () => {
    ...
    // 5 acct open Trove with 1 ether and withdraws 180 USDH (inc gas comp)
    ...
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[4], ZERO_ADDRESS, {
      from: accounts[4]
    });
    ...
    // Account 100 provides 360 USDH to SP
    await borrowerOperations.withdrawUSDH(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, {
      from: accounts[100]
    });
  ...
  it("", async () => {
    ...
    //4 acct open Trove with 1 ether and withdraws 180 USDH (inc gas comp)
    await th.openTrove_allAccounts(accounts.slice(0, 4), contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1]
    });
    ...
    // account 1 180 USDH liquidated  - partial offset
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] });
    const gas = th.gasUsed(tx);
    th.logGas(gas, message);
  ...
  it("", async () => {
    ...
    // account 1 70 USDH liquidated  - partial offset against 50 USDH in SP
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] });
    const gas = th.gasUsed(tx);
    th.logGas(gas, message);
  ...
  it("", async () => {
    ...
    //Account 99 and 98 each open Trove with 1 ether, and withdraw 180 USDH (inc gas comp)
    await th.openTrove_allAccounts([accounts[99]], contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[99], ZERO_ADDRESS, {
      from: accounts[99]
    });
    await th.openTrove_allAccounts([accounts[98]], contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[98], ZERO_ADDRESS, {
      from: accounts[98]
    });

    // Acct 99 deposits 1 USDH to SP
    await stabilityPool.provideToSP(dec(1, 18), ZERO_ADDRESS, { from: accounts[99] });

    //Account 97 opens Trove with 1 ether and withdraws 180 USDH (inc gas comp)
    await th.openTrove_allAccounts([accounts[97]], contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawUSDH(_100pct, dec(130, 18), accounts[97], ZERO_ADDRESS, {
      from: accounts[97]
    });

    // Acct 100 withdraws 1800 USDH and deposits it to the SP
    await borrowerOperations.withdrawUSDH(_100pct, dec(1750, 18), accounts[100], ZERO_ADDRESS, {
      from: accounts[100]
    });
    ...
    // Account 7 deposits 1 USDH in the Stability Pool
  ...
  it("", async () => {
    ...
    // 30 accts each open Trove with 10 ether, withdraw 180 USDH, and provide 180 USDH to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(100, 130), contracts, dec(10, "ether"), 0);
    await th.withdrawUSDH_allAccounts(accounts.slice(100, 130), contracts, dec(130, 18));

    await stabilityPool.provideToSP(dec(130, 18), ZERO_ADDRESS, { from: accounts[100] });

    //1 acct open Trove with 1 ether and withdraws 180 USDH (inc gas comp)
