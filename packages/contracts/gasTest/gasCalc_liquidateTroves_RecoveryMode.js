...
contract("Gas cost tests", async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 USDH
    ...
    //1 accts open Trove with 1 ether and withdraw 100 USDH
    ...
    // Account 500 opens with 1 ether and withdraws 100 USDH
    ...
    // Check initial troves with starting 10E/90USDH are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 USDH
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(10, "ether"),
    ...
    //20 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 USDH
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion USDH
    ...
    // Check SP has 9e28 USDH
    const USDHinSP = (await stabilityPool.getTotalUSDHDeposits()).toString();
    assert.equal(USDHinSP, dec(9, 28));

    //1 acct opens Trove with 1 ether and withdraw 100 USDH
    const _1_Defaulter = accounts.slice(1, 2);
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, "ether"), dec(60, 18));
    ...
    // Check initial troves with starting 10E/90USDH, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
    assert.isTrue(await sortedTroves.contains(whale));

    //Check USDH in SP has decreased but is still > 0
    const USDHinSP_After = await stabilityPool.getTotalUSDHDeposits();
    assert.isTrue(USDHinSP_After.lt(web3.utils.toBN(dec(9, 28))));
    assert.isTrue(USDHinSP_After.gt(web3.utils.toBN("0")));
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 USDH
    const _2_Defaulters = accounts.slice(1, 3);
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, "ether"), dec(60, 18));
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 USDH
    const _45_Defaulters = accounts.slice(1, 46);
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, "ether"), dec(9500, 18));
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 USDH
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraws USDH
    ...
    // Account 500 opens with 1 ether and withdraws USDH
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 USDH
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS, {
      from: accounts[500],
      value: dec(100, "ether")
    });
