...
const liquidatableInRecoveryMode = (
  ...
  if (collateralRatio.gte(MINIMUM_COLLATERAL_RATIO) && collateralRatio.lt(totalCollateralRatio)) {
    return [
      trove.debt.lte(usdhInStabilityPool),
      "There's not enough USDH in the Stability pool to cover the debt"
    ] as const;
  } else {
            ...
            <thead>
              <tr>
                ...
                <th>
                  ...
                  <Box sx={{ fontSize: [0, 1], fontWeight: "body", opacity: 0.5 }}>MATIC</Box>
                </th>
                <th>
                  Debt
