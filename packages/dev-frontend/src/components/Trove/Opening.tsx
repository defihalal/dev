...
export const Opening: React.FC = () => {
  ...
  const totalDebt = borrowAmount.add(USDH_LIQUIDATION_RESERVE).add(fee);
  ...
  useEffect(() => {
    if (!collateral.isZero && borrowAmount.isZero) {
      setBorrowAmount(USDH_MINIMUM_NET_DEBT);
    }
  ...
  return (
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        ...
        {description ?? (
          <ActionDescription>
            Start by entering the amount of MATIC you'd like to deposit as collateral.
          </ActionDescription>
        )}
