...
import { Decimal, USDH_MINIMUM_NET_DEBT, Trove } from "@liquity/lib-base";

import App from "./App";

const params = { depositCollateral: Decimal.from(20), borrowUSDH: USDH_MINIMUM_NET_DEBT };
...
test("there's no smoke", async () => {
  ...
  expect(await findByText(/you can borrow usdh by opening a trove/i)).toBeInTheDocument();
