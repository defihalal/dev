...
|  --- | --- | --- |
|  [frontendTag?](./lib-ethers.ethersliquityconnectionoptionalparams.frontendtag.md) | string | <i>(Optional)</i> Address that will receive HALAL rewards from newly created Stability Deposits by default. |
|  [userAddress?](./lib-ethers.ethersliquityconnectionoptionalparams.useraddress.md) | string | <i>(Optional)</i> Address whose Trove, Stability Deposit, HALAL Stake and balances will be read by default. |
