...
|  [HALALStake](./lib-base.halalstake.md) | Represents a user's HALAL stake and accrued gains. |
...
|  [RedemptionDetails](./lib-base.redemptiondetails.md) | Details of a [redeemUSDH()](./lib-base.transactableliquity.redeemusdh.md) transaction. |
...
|  [StabilityDepositChangeDetails](./lib-base.stabilitydepositchangedetails.md) | Details of a [depositUSDHInStabilityPool()](./lib-base.transactableliquity.depositusdhinstabilitypool.md) or [withdrawUSDHFromStabilityPool()](./lib-base.transactableliquity.withdrawusdhfromstabilitypool.md) transaction. |
...
|  [USDH\_LIQUIDATION\_RESERVE](./lib-base.usdh_liquidation_reserve.md) | Amount of USDH that's reserved for compensating the liquidator of a Trove. |
|  [USDH\_MINIMUM\_DEBT](./lib-base.usdh_minimum_debt.md) | A Trove must always have at least this much debt. |
|  [USDH\_MINIMUM\_NET\_DEBT](./lib-base.usdh_minimum_net_debt.md) | A Trove must always have at least this much debt on top of the [liquidation reserve](./lib-base.usdh_liquidation_reserve.md)<!-- -->. |
...
|  [HALALStakeChange](./lib-base.halalstakechange.md) | Represents the change between two states of an HALAL Stake. |
