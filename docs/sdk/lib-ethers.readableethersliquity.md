...
|  [getHALALBalance(address, overrides)](./lib-ethers.readableethersliquity.gethalalbalance.md) |  | Get the amount of HALAL held by an address. |
|  [getHALALStake(address, overrides)](./lib-ethers.readableethersliquity.gethalalstake.md) |  | Get the current state of an HALAL Stake. |
|  [getLiquidityMiningHALALReward(address, overrides)](./lib-ethers.readableethersliquity.getliquiditymininghalalreward.md) |  | Get the amount of HALAL earned by an address through mining liquidity. |
|  [getLiquidityMiningStake(address, overrides)](./lib-ethers.readableethersliquity.getliquidityminingstake.md) |  | Get the amount of Uniswap ETH/USDH LP tokens currently staked by an address in liquidity mining. |
...
|  [getRemainingLiquidityMiningHALALReward(overrides)](./lib-ethers.readableethersliquity.getremainingliquiditymininghalalreward.md) |  | Get the remaining HALAL that will be collectively rewarded to liquidity miners. |
|  [getRemainingStabilityPoolHALALReward(overrides)](./lib-ethers.readableethersliquity.getremainingstabilitypoolhalalreward.md) |  | Get the remaining HALAL that will be collectively rewarded to stability depositors. |
...
|  [getTotalStakedHALAL(overrides)](./lib-ethers.readableethersliquity.gettotalstakedhalal.md) |  | Get the total amount of HALAL currently staked. |
|  [getTotalStakedUniTokens(overrides)](./lib-ethers.readableethersliquity.gettotalstakedunitokens.md) |  | Get the total amount of Uniswap ETH/USDH LP tokens currently staked in liquidity mining. |
...
|  [getUniTokenAllowance(address, overrides)](./lib-ethers.readableethersliquity.getunitokenallowance.md) |  | Get the liquidity mining contract's allowance of a holder's Uniswap ETH/USDH LP tokens. |
|  [getUniTokenBalance(address, overrides)](./lib-ethers.readableethersliquity.getunitokenbalance.md) |  | Get the amount of Uniswap ETH/USDH LP tokens held by an address. |
|  [getUSDHBalance(address, overrides)](./lib-ethers.readableethersliquity.getusdhbalance.md) |  | Get the amount of USDH held by an address. |
|  [getUSDHInStabilityPool(overrides)](./lib-ethers.readableethersliquity.getusdhinstabilitypool.md) |  | Get the total amount of USDH currently deposited in the Stability Pool. |
