...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowUSDH</code>. |
...
The transaction will fail if the Trove's debt would fall below [USDH\_MINIMUM\_DEBT](./lib-base.usdh_minimum_debt.md)<!-- -->.
